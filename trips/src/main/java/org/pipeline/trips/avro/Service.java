...
public class Service extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9144484889340093020L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Service\",\"namespace\":\"org.pipeline.trips.avro\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"label\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Label\",\"fields\":[{\"name\":\"ar\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"en\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"fr\",\"type\":[\"null\",\"string\"],\"default\":null}]}],\"default\":null}]}");
   ...
   */
  public Service(java.lang.CharSequence id, org.pipeline.trips.avro.Label label) {
    this.id = id;
    this.label = label;
  }
   ...
   */
  public static org.pipeline.trips.avro.Service.Builder newBuilder() {
    return new org.pipeline.trips.avro.Service.Builder();
  }
   ...
   * @return A new Service RecordBuilder
   */
  public static org.pipeline.trips.avro.Service.Builder newBuilder(org.pipeline.trips.avro.Service.Builder other) {
    if (other == null) {
      return new org.pipeline.trips.avro.Service.Builder();
    } else {
      return new org.pipeline.trips.avro.Service.Builder(other);
    }
  }
   ...
   * @return A new Service RecordBuilder
   */
  public static org.pipeline.trips.avro.Service.Builder newBuilder(org.pipeline.trips.avro.Service other) {
    if (other == null) {
      return new org.pipeline.trips.avro.Service.Builder();
    } else {
      return new org.pipeline.trips.avro.Service.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Service>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.pipeline.trips.avro.Service.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.pipeline.trips.avro.Service other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.pipeline.trips.avro.Service.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.pipeline.trips.avro.Service.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.pipeline.trips.avro.Service.Builder setLabel(org.pipeline.trips.avro.Label value) {
    ...
    public org.pipeline.trips.avro.Service.Builder setLabelBuilder(org.pipeline.trips.avro.Label.Builder value) {
      clearLabel();
      labelBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public org.pipeline.trips.avro.Service.Builder clearLabel() {
      label = null;
      labelBuilder = null;
